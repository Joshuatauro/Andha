      ...
      <div className="grid grid-cols-2 max-h-screen relative">
        ...
        <div className="h-screen flex justify-center items-center" style={{backgroundColor: "#413E51"}}>
          <div className=" w-9/12 m-auto ">
            <h2 className="text-3xl text-left font-black" style={{color: "#55C9FF"}}>SignUp</h2>
            ...
            <div className="flex flex-col mt-3">
                ...
                <input type="email" value={email} onChange={e => setEmail(e.target.value)} className=" text-md flex-g px-3 py-2 text-white h-10 bg-transparent border-gray-400 border rounded-lg outline-none focus:ring-2 focus:ring-blue-400 " />
              </div>
              ...
              <p className="text-left text-xs mt-1 text-white">Already have an account? Click <Link to="/login" className="text-blue-500" style={{color: "#2EC2F1"}}> here</Link> </p>
            </form>
          </div>
        </div>
      </div>
