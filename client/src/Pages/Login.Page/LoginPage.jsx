          ...
          <div className=" w-9/12 m-auto ">
            ...
            <form onSubmit={logInUser} className="mt-7">
              <div className="flex flex-col">
                ...
                <input type="text" value={username} onChange={e => setUsername(e.target.value)} className=" text-sm flex-g px-3 py-2 text-white h-10 bg-transparent border-gray-400 border rounded-lg outline-none focus:ring-1 focus:ring-blue-400 font-semibold " />
              </div>
              <div className="flex flex-col mt-3">
                <label  className="text-xs text-gray-100 font-bold pl-2 pb-1 text-left ">Password</label>
                <input type="password" value={password} onChange={e => setPassword(e.target.value)} className=" text-md flex-g px-3 py-2 text-white h-10 bg-transparent border-gray-400 border rounded-lg outline-none focus:ring-1 focus:ring-blue-400 " />
              </div>
